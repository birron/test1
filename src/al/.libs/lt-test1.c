...
/* ./.libs/lt-test1.c - temporary wrapper executable for .libs/test1.exe
...
const char * TARGET_PROGRAM_NAME = "test1.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# test1 - temporary wrapper script for .libs/test1.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The test1 program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"test1.exe:test1:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test1.exe:test1:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test1.exe:test1:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
